            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="form-group row">
                            <label for="nohp" class="col-md-2 col-form-label text-md-right">No Handphone</label>

                            <div class="col-md-6">
                                <input type="number" id="nohp" type="text" class="form-control @error('nohp') is-invalid @enderror" name="nohp" value="{{ $user->nohp }}" required autocomplete="nohp" autofocus>
